                ...
                {users.map((user, index) => (
                    <video
                      ...
                      className={`
                        ...
                        ${users.length == 2 && "w-60 h-32 md:w-52 md:h-80 xl:w-[350px] xl:h-[450px]"}
                        ${users.length == 3 && "w-40 h-48 md:w-72 md:h-40 xl:w-[300px] xl:h-[400px]"}
                        ${users.length == 4 && "w-40 sm:w-52 xl:w-[320px] h-32 xl:h-[220px] sm:h-48"}
                        ${users.length == 1 && "w-60 h-48 md:w-80 md:h-[320px] xl:w-[550px] xl:h-[450px]"}
                        ${users.length == 0 && "w-60 h-48 md:w-80 md:h-96 xl:w-[550px]"} md:rounded-lg border object-fit border-purple-600`}
                    ></video>
                  ))}
                    <video
                      ref={localVideo}
                      ...
                      className={`
                        ...
                        ${users.length == 4 && "w-40 sm:w-52 xl:w-[320px] h-32 xl:h-[220px] sm:h-48"}
                        ${users.length == 1 && "w-60 h-48 md:w-80 md:h-[320px] xl:w-[550px] xl:h-[450px]"}
                        ${users.length == 0 && "w-60 h-48 md:w-80 md:h-96 xl:w-[550px]"} md:rounded-lg border object-fit border-red-600`}
                    ></video>
                  </div>
